...
description: Use when creating or reviewing scientific plots, figures, tables, captions, accessibility, or visual layout and quality.
---
...
- Encode groups with color plus marker, line style, shape, pattern, direct label, or position. Never rely on color alone.
- Use accessible contrast appropriate to text or graphical objects and test the actual palette when possible.
- Set typography and line weights for final display size, not the editing canvas.
...
Do not claim accessibility or visual correctness without fresh inspection evidence.
