...
3. **Task:** plan, research, analyze, draft, visualize, review, format, or submit.
4. **Output:** Markdown/source, DOCX, LaTeX, or a user-provided venue template.
5. **Rigor:** quick, standard, or submission.
...
Execute sequentially when parallel orchestration is unavailable or unnecessary.

Never fabricate citations, metadata, quotations, data, analyses, results, approvals, or compliance. Missing evidence must block or narrow the affected claim; unavailable capabilities require a precise manual next step.
